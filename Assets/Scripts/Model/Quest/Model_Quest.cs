...
public class Model_Quest : MonoBehaviour
{
    ...
    public string[] questTalkNPC; //任务完成需要对话的NPC
    ...
    {
        return string.Format("{0}, Id: {1}, QuestBriefIntroduction: {2}, QuestSescribe: {3}, QuestDialogueNpc: {4}, QuestDialoguePlayer: {5}, QuestBranch: {6}, QuestLevelLimit: {7}, QuestTalkNpc: {8}, QuestState: {9}, QuestKillEnemy: {10}, QuestItem: {11}, QuestReward: {12}", base.ToString(), id, questBriefIntroduction, questSescribe, questDialogueNpc, questDialoguePlayer, questBranch, questLevelLimit, questTalkNPC, questState, questKillEnemy, questItem, questReward);
    }
}